...
<head>
    ...
    <script src="${APP_PATH }/adminjs/jquery.min.js"></script>
    <script src="${APP_PATH }/adminjs/bootstrap.min.js"></script>
    ...
    <script>
        ...
        function showMovies() {
            ...
            xhr.open('POST', '${pageContext.request.contextPath }/movie/all', true);
            xhr.send();
    ...
    <!--[if lt IE 9]>
    <script src="${APP_PATH }/adminjs/html5shiv.min.js"></script>
    <script src="${APP_PATH }/adminjs/respond.min.js"></script>
    <![endif]-->
    <link href="${APP_PATH }/admincss/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="${APP_PATH }/admincss/common.css"/>
    <link rel="stylesheet" type="text/css" href="${APP_PATH }/admincss/slide.css"/>
    <link rel="stylesheet" type="text/css" href="${APP_PATH }/admincss/bootstrap.min.css"/>
    <link rel="stylesheet" type="text/css" href="${APP_PATH }/admincss/flat-ui.min.css"/>
    <link rel="stylesheet" type="text/css" href="${APP_PATH }/admincss/jquery.nouislider.css">
    <script>
        function hi()
        {
            $.ajax({
                ...
                success: function (result) {
                    $('#bannerdata').html("当前广告位电影为" +result.moviename+",导演："+result.director+",上映时间:"+result.releasetime);
        ...
        function search() {
            ...
            // let name = ${'#inputname'}.attr('value');
            // let  moviename = ${'#inputname'}.attr('value');
            //let moviename= 'toy';

            let moviename = document.getElementById("inputname").value;
            $.ajax({
                url: '${pageContext.request.contextPath }/movie/searchForBanner',
                type: 'get',
                ...
                success: function(result) {
                    ...
                    for(let i in result){ //第一层循环取到各个list
                        str += "<div class=\"row\"><div class=\"col-xs-2 \">"+result[i].movieid+
                                "</div><div class=\"col-xs-2\">"+result[i].moviename+
                                "</div><div class=\"col-xs-2\">"+result[i].typelist+
                                "</div><div class=\"col-xs-2\">"+result[i].director+
                                "</div><div class=\"col-xs-2\">"+result[i].releasetime+
                                "</div></div>"
                    }
        ...
        function pushBanner() {
            ...
            let movieid1 = document.getElementById("movieid1").value;
            let movieid2 = document.getElementById("movieid2").value;
            ...
            $.ajax({
                url: '${pageContext.request.contextPath }/movie/updateBanner',
                type: 'post',
                data: {movieid: movieid1},
                dataType: 'json',
                async: false,
                success: function(result) {
                    alert("推送成功!");
...
<div id="wrap">
    ...
    <div class="leftMeun" id="leftMeun">
        <div id="logoDiv">
            <p id="logoP"><img id="logo" alt="后台管理" src="${APP_PATH }/adminimages/logo.png"><span>后台管理</span></p>
        </div>
        <div id="personInfor">
    ...
    <div id="rightContent">
        ...
        <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane" id="sour">
                ...
                <div class="check-div form-inline" style="">
                    <div class="col-lg-4 col-xs-7 col-md-6">
                        ...
                        <form action="${pageContext.request.contextPath }/movie/all" method="post"
                              style="display: inline;">
                            <button type="submit" class="btn btn-yellow btn-xs">显示全部</button>
                        </form>


                        <button class="btn btn-yellow btn-xs" data-toggle="modal" data-target="#addBuilding">添加电影
                        </button>
                        <label for="paixu">电影名:&nbsp;</label>
                        <form action="${pageContext.request.contextPath }/movie/search" method="post"
                              style="display: inline;">
                            <input type="text" name="moviename" class=" form-control input-sm " placeholder="输入文字搜索">
                            <button class="btn btn-white btn-xs ">搜 索</button>
                        </form>
                    </div>
                        ...
                        <c:forEach items="${movielist}" var="movie">
                            <div id="${movie.movieid}" class="row">
                                ...
                                <div class="col-xs-4">
                                    ...
                                    <a target="_blank"
                                       href="http://localhost:8080/movie/movie/detailForAdmin?movieid=${movie.movieid}"> ${movie.moviename}</a>
                                ...
                                <div class="col-xs-2">
                                    <button id="deletebutton" onclick="del_div('${movie.movieid}')" class="btn btn-danger btn-xs" style="margin-top: 20px;" data-toggle="modal" >删除
                                    </button>
                                </div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="gridSystemModalLabel">添加电影</h4>
                            </div>
                            <div class="modal-body">
                                <div class="container-fluid">


                                    <form class="form-horizontal" id="addMovie" action="${pageContext.request.contextPath }/movie/add" method="post">
                                        <div class="form-group ">
                                            <label for="moviename" class="col-xs-3 control-label">名称：</label>
                                            <div class="col-xs-8 ">
                                                <input name="moviename" class="form-control input-sm duiqi" id="moviename"
                                                       placeholder="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="director" class="col-xs-3 control-label">导演：</label>
                                            <div class="col-xs-8 ">
                                                <input name="director" class="form-control input-sm duiqi" id="director"
                                                       placeholder="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="releasetime" class="col-xs-3 control-label">日-月-年：</label>
                                            <div class="col-xs-8">
                                                <input type="date" name="releasetime" class="form-control input-sm duiqi" id="releasetime"
                                                       placeholder="" style="height: 35px;">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="leadactors" class="col-xs-3 control-label">主演：</label>
                                            <div class="col-xs-8">
                                                <input name="leadactors" class="form-control input-sm duiqi" id="leadactors"
                                                       placeholder="">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="typelist" class="col-xs-3 control-label">类型：</label>
                                            <div class="col-xs-8" style="width: 250px;" id="typelist">
                                                <label><input name="typelist" type="checkbox" value="Animation" />Animation </label>
                                                <label><input name="typelist" type="checkbox" value="Comedy" />Comedy </label>
                                                <label><input name="typelist" type="checkbox" value="Family" />Family </label>
                                                <label><input name="typelist" type="checkbox" value="Adventure" />Adventure </label>
                                                <label><input name="typelist" type="checkbox" value="Fantasy" />Fantasy </label>

                                                <label><input name="typelist" type="checkbox" value="Action" />Action </label>
                                                <label><input name="typelist" type="checkbox" value="Drama" />Drama </label>
                                                <label><input name="typelist" type="checkbox" value="Crime" />Crime </label>
                                                <label><input name="typelist" type="checkbox" value="Thriller" />Thriller </label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="description" class="col-xs-3 control-label">简介：</label>

                                            <textarea name="description" class="form-control input-sm duiqi" id="description"
                                                      placeholder="">
                                                </textarea>
                                        </div>
                                    </form>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" onclick="function addMovie() {
                                    document.getElementById('addMovie').submit();//js原生方式表单提交

                                }
                                addMovie();" class="btn btn-xs btn-green">提 交</button>
                            </div>
                        </div>
                        <!-- /.modal-content -->
                    </div>
            ...
            <div role="tabpanel" class="tab-pane active" id="chan">
                <div id="bannerdata" class="check-div">
                    当前首页广告位电影为:
                </div>
                <div style="padding: 50px 0;margin-top: 50px;background-color: #fff; text-align: right;width: 420px;margin: 50px auto;">
                    <form class="form-horizontal">
                        <div class="form-group">
                            <label for="sKnot" class="col-xs-4 control-label">电影名：</label>
                            <div class="col-xs-5">
                                <input id="inputname" type="text" class="form-control input-sm duiqi" placeholder=""
                        ...
                        <div class="form-group text-right">
                            <div class="col-xs-offset-4 col-xs-5" style="margin-left: 169px;">
                                <button id="findbutton" type="button" onclick="search()" class="btn btn-xs btn-white">查 找</button>
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="sKnot" class="col-xs-4 control-label">推送id：</label>
                            <div class="col-xs-5">
                                <input id="movieid1" type="text" class="form-control input-sm duiqi" placeholder=""
                                       style="margin-top: 7px;">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="sKnot" class="col-xs-4 control-label">重复推送id：</label>
                            <div class="col-xs-5">
                                <input id="movieid2" type="text" class="form-control input-sm duiqi"  placeholder=""
                                       style="margin-top: 7px;">
                            </div>
                        </div>
                        <div class="form-group text-right">
                            <div class="col-xs-offset-4 col-xs-5" style="margin-left: 169px;">
                                ...
                                <button type="button"  onclick="pushBanner()"  class="btn btn-xs btn-green">推 送</button>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="data-div">
                    ...
                    <div 🆔 id="resulttable" class="tablebody">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-2">
                                ${bannerMovie.moviename}
                            </div>
                            <div class="col-xs-2">
                                ${bannerMovie.typelist}
                            </div>
                            <div class="col-xs-2">
                                ${bannerMovie.directors}
                            </div>
                            <div class="col-xs-2">
                                ${bannerMovie.releasetime}
                            </div>
                        </div>
...
-->
<script src="${APP_PATH }/adminjs/jquery.nouislider.js"></script>
